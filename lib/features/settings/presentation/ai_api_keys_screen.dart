      ...
      return AlertDialog(
        ...
        content: SizedBox(
          ...
          child: SingleChildScrollView(child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            TextField(controller: nameCtrl, style: TextStyle(color: baseColor), decoration: InputDecoration(labelText: 'Key Name', hintText: 'e.g. BazaarLink Free', labelStyle: TextStyle(color: dimColor), floatingLabelStyle: TextStyle(color: dimColor, fontSize: 12), hintStyle: TextStyle(color: dimColor), filled: true, fillColor: fillColor, border: OutlineInputBorder(borderRadius: BorderRadius.circular(12)))),
            const SizedBox(height: 12),
            DropdownButtonFormField<String>(
              value: provider,
              dropdownColor: bgColor,
              style: TextStyle(color: baseColor),
              decoration: InputDecoration(labelText: 'Provider', labelStyle: TextStyle(color: dimColor), floatingLabelStyle: TextStyle(color: dimColor, fontSize: 12), filled: true, fillColor: fillColor, border: OutlineInputBorder(borderRadius: BorderRadius.circular(12))),
    ...
    showDialog(context: context, builder: (d) => StatefulBuilder(builder: (ctx, setDialog) {
      return AlertDialog(
        ...
        content: SizedBox(
          width: 500,
          child: SingleChildScrollView(child: Column(mainAxisSize: MainAxisSize.min, children: [
            TextField(controller: nameCtrl, style: TextStyle(color: baseColor), decoration: InputDecoration(labelText: 'Key Name', labelStyle: TextStyle(color: dimColor), floatingLabelStyle: TextStyle(color: dimColor, fontSize: 12), filled: true, fillColor: fillColor, border: OutlineInputBorder(borderRadius: BorderRadius.circular(12)))),
            const SizedBox(height: 12),
            DropdownButtonFormField<String>(
              value: provider,
              dropdownColor: bgColor,
            ...
            const SizedBox(height: 12),
            TextField(controller: baseUrlCtrl, style: TextStyle(color: baseColor), decoration: InputDecoration(labelText: 'Base URL', labelStyle: TextStyle(color: dimColor), floatingLabelStyle: TextStyle(color: dimColor, fontSize: 12), filled: true, fillColor: fillColor, border: OutlineInputBorder(borderRadius: BorderRadius.circular(12)))),
            const SizedBox(height: 12),
            TextField(controller: keyCtrl, style: TextStyle(color: baseColor), maxLines: 3, decoration: InputDecoration(labelText: 'API Key', labelStyle: TextStyle(color: dimColor), floatingLabelStyle: TextStyle(color: dimColor, fontSize: 12), filled: true, fillColor: fillColor, border: OutlineInputBorder(borderRadius: BorderRadius.circular(12)))),
            const SizedBox(height: 12),
            _ModelsEditor(
